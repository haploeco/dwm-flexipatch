...
static char urgfgcolor[]                 = "#beadc4";
static char urgbgcolor[]                 = "#4F355B";
...
#endif // NAMETAG_PATCH
{
	[DEFAULT_TAGS]        = { "💻work", "🦡code", "🍄gsd", "🐍py", "chat", "🎵music", "👺tf", "🍕haplo", "🕸 web" },
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_t,          setlayout,              {.v = &layouts[8]} }, /* spiral */
	{ MODKEY|ShiftMask,             XK_t,          setlayout,              {.v = &layouts[9]} }, /* dwindle */
	{ MODKEY,                       XK_f,          setlayout,              {.v = &layouts[1]} }, /* floating */
	{ MODKEY,                       XK_m,          setlayout,              {.v = &layouts[2]} }, /* monocle */
	{ MODKEY|ShiftMask,             XK_m,          setlayout,              {.v = &layouts[5]} }, /* centeredmaster */
	{ MODKEY|ControlMask,           XK_m,          setlayout,              {.v = &layouts[6]} }, /* centeredfloatingmaster */
	{ MODKEY,                       XK_u,          setlayout,              {.v = &layouts[7]} },  /* deck */
	{ MODKEY|ShiftMask,             XK_u,          setlayout,              {.v = &layouts[3]} },  /* bstack */
	{ MODKEY|ControlMask,           XK_u,          setlayout,              {.v = &layouts[4]} },  /* bstack horizontal*/
	{ MODKEY,                       XK_g,          setlayout,              {.v = &layouts[10]} },  /* grid */
	{ MODKEY|ShiftMask,             XK_g,          setlayout,              {.v = &layouts[13]} },  /* nrowgrid */
	{ MODKEY|ControlMask,           XK_g,          setlayout,              {.v = &layouts[11]} },  /* horizgrid */
	{ MODKEY|ShiftMask|ControlMask, XK_g,          setlayout,              {.v = &layouts[12]} }, /* gaplessgrid */
	#if COLUMNS_LAYOUT
